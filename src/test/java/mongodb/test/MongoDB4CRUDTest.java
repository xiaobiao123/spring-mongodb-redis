...
public class MongoDB4CRUDTest {
    ...
    public void remove() {
        queryAll();
         ...
         //dbCollection.remove(new BasicDBObject("_id",new ObjectId("59f18a13c94b911bd42ea90f"))));
    ...
    public void modify() {
        ...
        //        false// 多条修改
        //));
        //print("修改：" + dbCollection.update(new BasicDBObject("name", "haha"), new BasicDBObject("name", "dingding"),
        //        true, // 如果数据库不存在，是否添加
        //        true// false只修改第一天，true如果有多条就不修改
        //));

        dbCollection.update(new BasicDBObject("_id",new ObjectId("59f18a85c94b9117745b83a5")),new BasicDBObject("mongodbAge","123"),true,false);
