...
public class ExcelLinkage2007Test {
    ...
    private void init() {
        map.put(province.get(0), hnCity);
        map.put(province.get(1), gdCity);
    }
    ...
    public void Export() {
        try {
            ...
            // 设置sheet 名称
            XSSFSheet excelSheet = workbook.createSheet("excel");
            // 设置样式
    ...
    public static void main(String[] args) {
        ExcelLinkage2007Test linkage = new ExcelLinkage2007Test();
        linkage.Export();
    }
}