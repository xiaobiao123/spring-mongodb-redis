...
public class DistributedLock implements Watcher{
    ...
    private static final String CONNECTION_STRING = "172.30.22.239:2181";
     ...
     * @return
     */
    private void getLock(int threadId) throws KeeperException, InterruptedException {
        selfPath = zk.create(SUB_PATH+"0000"+threadId,null, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
