...
import com.cn.excel.GoodsExcelVo;
...
//        HSSF是指2007年以前的,XSSF是指2007年版本以上的
        ...
        File savefile = new File("D:/com.cn.excel/");
        if (!savefile.exists()) {
            savefile.mkdirs();
        }
        FileOutputStream fos = new FileOutputStream("D://com.cn.excel//big.xlsx");
        workbook.write(fos);
        workbook.close();
        fos.close();
...
//            HSSF是指2007年以前的,XSSF是指2007年版本以上的
            ...
            FileOutputStream fos = new FileOutputStream("D:/com.cn.excel/ExcelExportForMap.tt.xlsx");
            workbook.write(fos);
            fos.close();
